...
class GatewayService:
    ...
    def get_all_category(self, request):
        ...
        return categories['code'], self.header, json.dumps(categories['data'])
    ...
    def get_category_by_name(self, request, kategori):
        ...
        return category['code'], self.header, json.dumps(category['data'])
    ...
    def get_all_insurance(self, request):
        ...
        return insurances['code'], self.header, json.dumps(insurances['data'])
    ...
    def get_insurance_by_category_and_id(self, request, kategori, id_tipe_asuransi):
        ...
        return insurance['code'], self.header, json.dumps(insurance['data'])
